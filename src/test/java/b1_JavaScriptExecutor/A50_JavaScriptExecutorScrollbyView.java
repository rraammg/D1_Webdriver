...
public class A50_JavaScriptExecutorScrollbyView {
	...
	public static void main(String[] args) {
		...
		WD.findElement(By.name("element31")).click();
	WebElement	a=WD.findElement(By.id("id6"));
		JavascriptExecutor b=(JavascriptExecutor)WD;
	b.executeScript("arguments[0].scrollIntoView()", a);
