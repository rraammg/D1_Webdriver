...
public class A19_DragandDrop {
	...
	public static void main(String[] args) {
	    ...
	    WD.get("https://djangovinoth.pythonanywhere.com/labhome/");
	     ...
	     WD.findElement(By.id("element25")).click();
	     Actions a=new Actions(WD);
	   WebElement b=WD.findElement(By.id("draggable"));
	WebElement c=WD.findElement(By.id("droppable"));
